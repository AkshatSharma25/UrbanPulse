        ...
        <div className="flex flex-col md:flex-row -mx-4">
          <div className="md:flex-1 px-4">
            <div className="h-[460px] overflow-hidden rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
              <img className="scale-150 w-full h-full object-cover" src={product.imageUrl} alt="Product Image" />
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center mt-2">
                {/* {product.colors.map((color, index) => (
                  <button key={index} className={`w-6 h-6 rounded-full bg-${color} dark:bg-${color}-700 mr-2`} />
                ))} */}
              </div>
            </div>
            <div className="mb-4">
